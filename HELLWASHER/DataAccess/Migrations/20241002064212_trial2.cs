    ...
    public partial class trial2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ClothUnitId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClothUnits", x => x.ClothUnitId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WashServiceTypeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTypes", x => x.WashServiceTypeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_ClothUnits_ClothUnitId",
                        column: x => x.ClothUnitId,
                        principalTable: "ClothUnits",
                        principalColumn: "ClothUnitId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "WashServiceTypeId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderStatusId = table.Column<int>(type: "int", nullable: false),
                    WashStatusId = table.Column<int>(type: "int", nullable: false),
